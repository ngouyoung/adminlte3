    ...
    <div class="row mb-2">
        <div class="col-md-6 col-sm-6 col-6">
            ...
            @can('create-group-permission')
                <a class="{{ config('class.button.create') }}"
                   href="{{ route('admin.assessments.group_permissions.create') }}">
        ...
        <div class="col-md-6 col-sm-6 col-6">
            <ol class="breadcrumb float-right">
                <li class="breadcrumb-item">
                    <a href="{{ route('admin.assessments.group_permissions.index') }}">Group Permission</a>
                </li>
...
@section('contents')
    <div class="card b-t-green">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.assessments.group_permissions.update', $object->id) }}">
                @method('PUT')
                @csrf
                ...
                <div class="row justify-content-end">
                    <div class="col-md-10 col-sm-9 col-8">
                        ...
                        <a class="{{ config('class.button.cancel') }}"
                           href="{{ route('admin.assessments.group_permissions.index') }}">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
