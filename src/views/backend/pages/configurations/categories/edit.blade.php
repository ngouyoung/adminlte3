...
@section('breadcrumb')
    <div class="row mb-2">
        <div class="col-md-6 col-sm-6 col-6">
            ...
            @can('create-category')
            <a class="{{ config('class.button.create') }}" href="{{ route('admin.configurations.categories.create') }}">
...
@section('contents')
    <div class="card b-t-green">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.configurations.categories.update', $object->id) }}">
                @method('PUT')
                @csrf
