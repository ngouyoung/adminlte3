...
@section('breadcrumb')
    <div class="row mb-2">
        <div class="col-md-6 col-sm-6 col-6">
            ...
            @can('create-unit')
            <a class="{{ config('class.button.create') }}" href="{{ route('admin.configurations.units.create') }}">
...
@section('contents')
    <div class="card b-t-green">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.configurations.units.update', $object->id) }}">
                @method('PUT')
                @csrf
